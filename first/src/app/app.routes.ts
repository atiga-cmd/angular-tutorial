    ...
    import { ListeRecruteursComponent } from "./liste-recruteurs/liste-recruteurs.component";
    import { InfoCandidatComponent } from "./info-candidat/info-candidat.component";
    import { AdminOffreComponent } from "./admin-offre/admin-offre.component";
    import { DeconnexionAdminComponent } from "./deconnexion-admin/deconnexion-admin.component";
    export const routes: Routes = [
       ...
       { path: 'home', component: HomeComponent }, // Route pour "Accueil"
        ...
        { path: 'modifier-profil-admin/:id', component: ModifierAdminComponent },
        { path: 'voir-recruteur/:id', component: ListeRecruteursComponent },
        { path: 'voir-candidat/:id', component:ListeCandidatsComponent  },
        { path: 'voir-plus/:id/:userId', component:InfoCandidatComponent  },

        { path: 'admin-offre/:id', component: AdminOffreComponent },
        {
          path: 'deconnexion-admin',
          loadComponent: () => import('./deconnexion-admin/deconnexion-admin.component').then(m => m.DeconnexionAdminComponent)
        },
